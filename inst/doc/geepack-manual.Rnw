...
\usepackage{boxedminipage,color,a4wide,shortvrb,hyperref}
...
The |geepack| package for generalized estimating equations is
described in Halekoh, U., Højsgaard, S., Yan, J. (2006). The package
geepack for generalized estimating equations. Journal of Statistical
Software. 15, 2. If you use |geepack| in your own work, please do cite
the above reference.
